 ...
 * @author root
 */
public class ConfigSystem extends ConfigAbstract{
    ...
    */
    ...
    public ConfigSystem(String path) throws ConfigException{
        super(path,constant.SystemConstantString.SYSTEM_NODE);
        
        this.unitTime = this.prefs.getLong(constant.SystemConstantString.UNIT_TIME, ConfigSystem.DEFAULT_UNIT_TIME);
        this.unitPayment = this.prefs.getLong(constant.SystemConstantString.UNIT_PAYMENT, ConfigSystem.DEFAULT_UNIT_PAYMENT);
        this.pointPerLogin = this.prefs.getInt(constant.SystemConstantString.POINT_PER_LOGIN, ConfigSystem.DEFAULT_POINT_PER_LOGIN);
        this.baseOfPower = this.prefs.getDouble(constant.SystemConstantString.BASE_OF_POWER, ConfigSystem.DEFAULT_BASE_OF_POWER);
        this.limitRecommendationGame = this.prefs.getInt(constant.SystemConstantString.LIMIT_RECOMMENDATION_GAME, ConfigSystem.DEFAULT_LIMIT_RECOMMENDATION_GAME);
        this.limitScoringGame =  this.prefs.getInt(constant.SystemConstantString.LIMIT_SCORING_GAME, ConfigSystem.DEFAULT_LIMIT_SCORING_GAME);

    }

    public ConfigSystem() throws ConfigException {
